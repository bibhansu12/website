...
<head>
    ...
    <title>SportsVerse - New Arrivals</title>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/header.css" />
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/newarrivals.css" />
...
<body class="light-mode">
                ...
                <div class="category-section">
                    ...
                    <div class="products-grid-container">
                        <c:forEach var="product" items="${entry.value}">
                            <a href="${pageContext.request.contextPath}/product?productId=${product.productId}" class="product-card">
                                <div class="product-image" style="background-image: url('<c:choose><c:when test="${product.mainImageUrl.startsWith('http://') || product.mainImageUrl.startsWith('https://')}">${product.mainImageUrl}</c:when><c:otherwise>${pageContext.request.contextPath}${product.mainImageUrl}</c:otherwise></c:choose>');">
                                ...
                                <div class="product-info">
                                    <form action="${pageContext.request.contextPath}/wishlist" method="post" class="wishlist-form">
                                        ...
                                        <input type="hidden" name="redirect" value="${pageContext.request.contextPath}/newarrivals" />
                                        <button type="submit" class="wishlist-btn ${not empty wishlistStatus[product.productId] ? 'in-wishlist' : ''}" title="${not empty wishlistStatus[product.productId] ? 'Remove from Wishlist' : 'Add to Wishlist'}">
    ...
    <script src="${pageContext.request.contextPath}/js/newarrivals.js"></script>
</body>
</html>